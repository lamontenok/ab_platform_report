...
# Встроенный список RSS-источников для MVP.
# Если в .env не задан RSS_FEEDS, агент возьмёт эти URL автоматически.
DEFAULT_RSS_FEEDS: List[str] = [
    # ===== GLOBAL =====
    # Google News по запросу "A/B testing platform" — агрегирует свежие мировые публикации по теме.
    "https://news.google.com/rss/search?q=A/B+testing+platform",
    # Google News по запросу "experimentation platform" — расширяет подборку смежными новостями.
    "https://news.google.com/rss/search?q=experimentation+platform",
    # TechCrunch — общий технологический новостной поток (стартапы, продуктовые инструменты, AI).
    "https://techcrunch.com/feed/",
    # VentureBeat — новости о технологиях, data/AI и enterprise-продуктах.
    "https://venturebeat.com/feed/",
    # Search Engine Land — полезно для экспериментов в SEO/маркетинге и growth-практик.
    "https://searchengineland.com/feed",
    # Mixpanel Blog RSS — продуктовая аналитика и практика измерений/экспериментов.
    "https://mixpanel.com/blog/rss/",

    # ===== RU =====
    # Google News RU по запросу "A/B тестирование" — русскоязычные новости по теме.
    "https://news.google.com/rss/search?q=A/B+тестирование&hl=ru&gl=RU&ceid=RU:ru",
    # Habr (RU all) — инженерные статьи и кейсы российских команд.
    "https://habr.com/ru/rss/all/all/?fl=ru",
    # vc.ru (all) — бизнес/продуктовые новости и практические материалы на русском.
    "https://vc.ru/rss/all",
    # CNews — российские IT-новости и рынок enterprise-решений.
...
def get_config() -> Config:
    ...
    # Если пользователь не задал RSS_FEEDS в .env, используем встроенный список источников.
    if not rss_feeds:
